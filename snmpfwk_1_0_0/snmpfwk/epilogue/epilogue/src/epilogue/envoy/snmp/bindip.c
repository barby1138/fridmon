/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/snmp/bindip.c,v 1.1 2006/06/29 12:17:26 smasyutin Exp $       */
 ...
 * no message
 *
 * Revision 8.0  1997/11/18 00:56:41  sar
 * Updated revision to 8.0
 *
 * Revision 7.2  1997/03/20 06:48:37  sra
 ...
 *
 * Revision 6.0  1995/05/31  21:47:09  sra
 * Release 6.0.
 *
 ...
 * Release 3.0
 *
 * Revision 2.103  91/10/30  20:41:37  dab
 * Directly include asn1conf.h, snmpdefs.h, and snmpstat.h (if needed).
 * 
 * Revision 2.102  91/08/15  12:30:43  dab
 * Removed <libfuncs.h>.
 * 
 * Revision 2.101  91/08/12  12:47:06  dab
 * Cast arguments to memcpy() and memset() to PTR_T.
 * 
 * Revision 2.100  91/08/09  14:08:14  dab
 * Update version.
 * 
 * Revision 1.1  91/07/30  02:23:23  romkey
 * Initial revision
 * 
 * 
...
****************************************************************************/
int
  SNMP_Bind_IP_Address(SNMP_PKT_T *pktp,
                       int         indx,
                       int         compc,
                       OIDC_T     *compl,
                       OCTET_T    *ipp)
...
(void) MEMCPY((PTR_T)vbp->value_u.v_network_address, (PTR_T)ipp, 4);
return 0;
}
