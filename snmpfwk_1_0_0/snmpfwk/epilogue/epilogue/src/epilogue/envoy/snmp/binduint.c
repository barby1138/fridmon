/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/snmp/binduint.c,v 1.1 2006/06/29 12:17:26 smasyutin Exp $ */
 ...
 *
 * Revision 7.2  1997/03/20 06:48:43  sra
 ...
 * removed uinteger32 & no_pp stuff
 *
 * Revision 6.0  1995/05/31  21:47:13  sra
 * Release 6.0.
 *
 ...
 *
 * Revision 3.1  1993/02/17  21:00:51  sar
 * Added data type VT_UINTEGER32
 *
 * Revision 3.0  92/04/03  19:52:37  dab
 * Release 3.0
 * 
 * Revision 2.102  91/10/30  20:41:40  dab
 * Directly include asn1conf.h, snmpdefs.h, and snmpstat.h (if needed).
 * 
 * Revision 2.101  91/08/15  12:30:46  dab
 * Removed <libfuncs.h>.
 * 
 * Revision 2.100  91/08/09  14:08:16  dab
 * Update version.
 * 
 * Revision 1.1  91/07/30  02:23:27  romkey
 * Initial revision
 * 
 * 
...
PARAMETERS:
        ...
        OCTET_T         Data type, VT_COUNTER, VT_GAUGE, VT_TIMETICKS,
                        VT_UINTEGER32 from snmp.h
        UINT_32_T       The value to be bound.

RETURNS:  int   0 if OK, -1 if failed
****************************************************************************/
int
  SNMP_Bind_Unsigned_Integer(SNMP_PKT_T *pktp,
                             int         indx,
                             int         compc,
                             OIDC_T     *compl,
