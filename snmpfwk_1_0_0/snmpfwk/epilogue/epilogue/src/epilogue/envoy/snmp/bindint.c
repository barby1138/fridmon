/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/snmp/bindint.c,v 1.1 2006/06/29 12:17:26 smasyutin Exp $ */
 ...
 *
 * Revision 7.2  1997/03/20 06:48:36  sra
 ...
 *
 * Revision 6.0  1995/05/31  21:47:07  sra
 * Release 6.0.
 *
 ...
 * Release 3.0
 *
 * Revision 2.102  91/10/30  20:41:36  dab
 * Directly include asn1conf.h, snmpdefs.h, and snmpstat.h (if needed).
 * 
 * Revision 2.101  91/08/15  12:30:42  dab
 * Removed <libfuncs.h>.
 * 
 * Revision 2.100  91/08/09  14:08:14  dab
 * Update version.
 * 
 * Revision 1.1  91/07/30  02:23:20  romkey
 * Initial revision
 * 
 * 
...
****************************************************************************/
int
  SNMP_Bind_Integer(SNMP_PKT_T *pktp,
                    int         indx,
                    int         compc,
                    OIDC_T     *compl,
                    INT_32_T    value)
