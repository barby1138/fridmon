/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/auxi/oidcmp2.c,v 1.1 2006/06/29 12:17:25 smasyutin Exp $ */
 ...
 *
 * Revision 7.2  1997/03/20 06:50:16  sra
 ...
 *
 * Revision 6.0  1995/05/31  21:50:51  sra
 * Release 6.0.
 *
 * Revision 5.0  1994/05/16  15:29:57  sar
 * Updated revision to 5.0 and copyright to 1994
 *
 * Revision 4.2  1994/03/08  18:02:30  dab
 * Mkae argument order consistent with oidcmp.
 *
 * Revision 4.1  1994/01/10  23:00:31  dab
 * taken from oidcmp.c
 *
 */
 ...
 */
int
  oidcmp2(int n1, OIDC_T *idp1, int n2, OIDC_T *idp2)
{
  while ((n1 > 0) && (n2 > 0)) {
    if (*idp1 != *idp2)
