/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/auxi/null_nas.c,v 1.1 2006/06/29 12:17:25 smasyutin Exp $ */
...
void
  null_next_async(OIDC_T         lastmatch,
                  int            compc,
                  OIDC_T        *compl,
                  SNMP_PKT_T    *pktp,
                  VB_T          *vbp)
{
nextproc_next_instance(pktp, vbp, 0, 0);
