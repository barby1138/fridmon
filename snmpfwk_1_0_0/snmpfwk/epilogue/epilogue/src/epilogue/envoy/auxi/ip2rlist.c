/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/auxi/ip2rlist.c,v 1.1 2006/06/29 12:17:25 smasyutin Exp $ */
 ...
 *
 * Revision 7.2  1997/03/20 06:50:06  sra
 ...
 * Release 3.0
 *
 * Revision 1.2  91/10/30  20:38:36  dab
 * Directly include asn1conf.h and snmpdefs.h.
 * 
 * Revision 1.1  91/10/30  18:11:59  dab
 * Initial revision
 * 
 * 
 */
...
/* ip_to_rlist() converts an IP address (in network byte order) into
 * an array of OIDC_T components and returns the component count
 * (always 4). Its argument rlist must have room for at least four
 * components.  */
int
  ip_to_rlist(UINT_32_T ip,
              OIDC_T *rlist)
{
  union {
    UINT_32_T laddr;
