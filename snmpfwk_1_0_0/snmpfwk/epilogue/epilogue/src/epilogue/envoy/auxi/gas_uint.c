/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/auxi/gas_uint.c,v 1.1 2006/06/29 12:17:25 smasyutin Exp $ */
 ...
 *
 * Revision 7.2  1997/03/20 06:49:54  sra
 ...
 *
 * Revision 6.0  1995/05/31  21:50:35  sra
 * Release 6.0.
 *
...
/* Get the 32-bit unsigned integer referenced by cookie. */

void
  get_uint_async(OIDC_T          lastmatch,
                 int             compc,
                 OIDC_T         *compl,
                 SNMP_PKT_T     *pktp,
                 VB_T           *vbp)
