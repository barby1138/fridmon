/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/auxi/oidorder.c,v 1.1 2006/06/29 12:17:25 smasyutin Exp $ */
 ...
 *
 * Revision 7.2  1997/03/20 06:50:17  sra
 ...
 *
 * Revision 3.0  1992/04/03  15:57:40  dab
 * Release 3.0
 *
 * Revision 1.3  92/04/03  13:53:01  dab
 * checked in with -k by dab at 92.04.03.15.57.02.
 * 
 * Revision 1.2  92/03/30  18:42:41  dab
 * Don't convert OIDC_T's to signed and so lose a bit of range.
 * 
 ...
 */
int
  oidorder(OIDC_T *idp1, OIDC_T *idp2, int n)
{
  while (n-- > 0) {
    if (*idp1 != *idp2)
