/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/auxi/null_tst.c,v 1.1 2006/06/29 12:17:25 smasyutin Exp $ */
...
/* For those variables which don't have a test proceedure. */
int
  null_test_proc(int         form,
                 OIDC_T      lastmatch,
                 int         compc,
                 OIDC_T     *compl,
                 char       *cookie,
