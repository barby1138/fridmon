/* $Header: /services/cvsroot/fridmon/snmpfwk_1_0_0/snmpfwk/epilogue/epilogue/src/epilogue/envoy/auxi/exist_as.c,v 1.1 2006/06/29 12:17:23 smasyutin Exp $ */
...
/*
 * $Log: exist_as.c,v $
 * Revision 1.1  2006/06/29 12:17:23  smasyutin
 * - epilogue version
 *
 ...
 *
 * Revision 6.0  1995/05/31  21:50:29  sra
 * Release 6.0.
 *
...
/* Test function for simple mib variables that have exactly one
   instance of 0, so the "object instance" , i.e. the unused
   portion of the object identifier, must be a single component of
   value zero.
 */

void
  it_exists_async(OIDC_T         lastmatch,
                  int            compc,
                  OIDC_T        *compl,
                  SNMP_PKT_T    *pktp,
                  VB_T          *vbp)
